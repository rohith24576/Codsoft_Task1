...
export const mockProducts = [
    ...
    { 
        ...
        category: { _id: '1', name: 'Men' }, stock: 35, isFeatured: false, ratings: 4.3, numReviews: 1, 
    ...
    { 
        ...
        category: { _id: '2', name: 'Women' }, stock: 10, isFeatured: true, ratings: 4.8, numReviews: 1, 
...
const getAllProducts = asyncHandler(async (req, res) => {
    if (process.env.USE_MOCK_DB === 'true') {
        const { category, search, sort, minPrice, maxPrice, size, color } = req.query;
    ...
    const { page = 1, limit = 10, search, category, minPrice, maxPrice, sort, size, color } = req.query;
    const query = {};
